...
public class T1_Circle_Drag_N_Drop {
    ...
    public void drag_and_drop_test() {
        ...
        //OneWayToDoIt--> actions.dragAndDrop(smallCircle, bigCircle).perform();
        actions.clickAndHold(smallCircle)                                           //<--2rdWayToDoIt
                .pause(2000)                                                        //<--UCanPause4 2sc
                .moveToElement(bigCircle)
                .pause(2000)
                .release()                                                         //<--WhatEverClick&HoldWillRelease
                .perform();
