package com.cydeo.tests.tests.tests.day4_FindElements_checkboxes_radio;
...
public class T1_xpath_cssSelector_practice {
    public static void main(String[] args) {
        ...
        //onWebForTheRelative Xpath onMyWebLocator ((TypeCommand+F) FirstApply--> //h2 the willLook insideTheHTML page
        //GiveMeAPoint jump showsMeWhere theFirstH2 -->Making things moreComplicated we dont have attribute
        //XpathAllowsUsToUse textAsWellInMyLocatorICanSay-->//h2[text()=] thenICopyMyText&Past-->//label[@for='email']
        //ToReturnDifferenceWebElementNeedToMakeLessSpecificRemove h2 &andApply*After//-->//*[text()='Forgot Password']
        // to be specific apply //h2[text()='Forgot Password']
        ...
        //"homeLink_ex1.isDisplayed()<--HomeLink isGoingInside HTML andMakeSureIsDisplayed orNot
